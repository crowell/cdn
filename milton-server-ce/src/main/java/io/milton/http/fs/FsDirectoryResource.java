...
//            w.begin("a").writeAtt("href", "#").writeAtt("onclick", "editDocument('" + path + "')").open().writeText("(edit with office)").close();
            ...
            w.begin("td").open().writeText(getMineType(r.getName())+"").close();
            w.close("tr");
        }
        w.close("table");
        w.close("body");
	...
	private String getMineType(String fileName) {
		if (fileName.equals("1.mp4"))
			return "Lecturer Video MP4 360P";
		if (fileName.equals("2.mp4"))
			return "Lecturer Video MP4 480P";
		if (fileName.equals("3.mp4"))
			return "Lecturer Video MP4 720P";
		if (fileName.equals("4.mp4"))
			return "Lecturer Video MP4 Mobile";
		if (fileName.equals("5.flv"))
			return "Lecturer Video Flash 360P";
		if (fileName.equals("6.flv"))
			return "Lecturer Video Flash 480P";
		if (fileName.equals("7.mp3"))
			return "Lecturer Audio MP3 128k";
		if (fileName.equals("9.mp4"))
			return "Presentation with Audio MP4 480P";
		if (fileName.equals("90.mp"))
			return "Presention with Audio MP4 Mobile";
		if (fileName.endsWith("webm"))
			return "Lecturer Video WEBM";
		if (fileName.equals("100.xml"))
			return "Presentation Info XML";
		if (fileName.equals("13.pdf"))
			return "PDF Document";
